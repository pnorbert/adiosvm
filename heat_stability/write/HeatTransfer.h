...
public:
    ...
    void init(MPI_Comm comm, bool init_with_rank); // set up array values with either rank or
                                                   // real demo values
    ...
    // overwrite local data with data provided
    void set_data_noghost(std::vector<double> v);
