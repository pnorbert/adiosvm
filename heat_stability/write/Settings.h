...
public:
    ...
    unsigned int iterations; // Number of computing iterations
    unsigned int write_freq; // Output step per N iterations
    unsigned int read_freq;  // Read back data per M iterations
